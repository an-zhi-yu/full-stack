...
public class PostController {
     ...
     * 类比 Express：router.get('/', listHandler) 挂在 app.use('/api/v1/posts', router)
     * 下面。
     *
     ...
     * 你们团队若约定「一律 200 + body.code」，也可以把下面改成
     * ResponseEntity.ok(ApiResult.ok(...))，效果仍是 200。
     *
     ...
     */
    /**
     * 详情：JSON 为「正文字段平铺」+ viewCount、likeCount、likedByCurrentUser（见
     * {@link BlogPostDetailDTO}）。
